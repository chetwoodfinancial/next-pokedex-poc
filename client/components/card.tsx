...
const Card = ({ chetmon }) => {
  ...
  return (
    <li
      className="block max-w-sm w-60 h-90 text-white px-2 pt-2 pb-4 bg-gray-700 m-5 rounded-lg shadow-md hover:bg-gray-500 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
      key={_id}
    >
      <Link
        href="/chetmon/[slug]"
